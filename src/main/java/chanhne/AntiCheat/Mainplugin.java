...
public class Mainplugin extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        flyCheck.startForOnlinePlayers();
        ...
        AntiAutoTotemCheck antiAutoTotemCheck = new AntiAutoTotemCheck(this);
        Bukkit.getPluginManager().registerEvents(antiAutoTotemCheck, this);
        antiAutoTotemCheck.startForOnlinePlayers();
        ...
        if (anticheatCommand != null) {
            anticheatCommand.setExecutor(commandHandler);
        } else {
            getLogger().severe("Không tìm thấy lệnh 'anticheat' - kiểm tra lại khai báo trong plugin.yml!");
        }
        ...
        getLogger().info("=================================");
        getLogger().info("  Mainplugin đã khởi động!");
